odoo.define('web.form_widgets', ['web.pyeval', 'web.session', 'web.data', 'web.Model', 'web.core', 'web.formats', 'web.utils', 'web.datepicker', 'web.form_common', 'web.Dialog', 'web.crash_manager', 'web.framework'], function (require) {
"use strict";
...
var FieldMany2ManyCheckBoxes = common.AbstractField.extend(common.ReinitializeFieldMixin, {
    ...
    query_records: function() {
        var self = this;
        var model = new Model(session, this.field.relation);
