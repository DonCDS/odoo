...
odoo.define('web.ListView', ['web.core', 'web.Model', 'web.View', 'web.session', 'web.utils', 'web.formats', 'web.data', 'web.DataExport', 'web.Sidebar', 'web.pyeval', 'web.list_common'], function (require) {
"use strict";
/*---------------------------------------------------------
 * Odoo List view
 *---------------------------------------------------------*/
...
var Model = require('web.Model'),
    ...
    DataExport = require('web.DataExport'),
    common = require('web.list_common'),
...
var Class = core.Class,
    ...
    py = core.py,
    moment = core.moment,
    list_widget_registry = core.list_widget_registry;
