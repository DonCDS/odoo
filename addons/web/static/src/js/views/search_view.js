odoo.define('web.SearchView', ['web.core', 'web.Model', 'web.Widget', 'web.AutoComplete', 'web.GroupByMenu', 'web.FilterMenu', 'web.FavoriteMenu', 'web.search_inputs', 'web.pyeval', 'web.framework', 'web.utils'], function (require) {
"use strict";
...
var core = require('web.core'),
    ...
    AutoComplete = require('web.AutoComplete'),
    GroupByMenu = require('web.GroupByMenu'),
    FilterMenu = require('web.FilterMenu'),
...
var SearchView = Widget.extend(/** @lends instance.web.SearchView# */{
    ...
    start: function() {
        ...
        var load_view = framework.fields_view_get({
