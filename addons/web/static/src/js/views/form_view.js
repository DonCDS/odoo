odoo.define('web.FormView', ['web.Model', 'web.View', 'web.utils', 'web.core', 'web.data', 'web.crash_manager', 'web.Dialog', 'web.Sidebar', 'web.form_common'], function (require) {
"use strict";
/*---------------------------------------------------------
 * Odoo Form view
 *---------------------------------------------------------*/
...
var FormView = View.extend(common.FieldManagerMixin, {
    ...
    build_eval_context: function() {
        var a_dataset = this.dataset;
        return new data.CompoundContext(this._build_view_fields_values(), a_dataset.get_context());
    },
});
