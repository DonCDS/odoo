odoo.define('web.form_relational', ['web.Dialog', 'web.core', 'web.ListView', 'web.data', 'web.FormView', 'web.ViewManager', 'web.utils', 'web.form_common', 'web.Model'], function (require) {
"use strict";
