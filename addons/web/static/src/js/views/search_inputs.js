odoo.define('web.search_inputs', ['web.Widget', 'web.core', 'web.Model', 'web.pyeval', 'web.data', 'web.utils', 'web.formats', 'web.time_utils'], function (require) {
"use strict";
...
var DateField = Field.extend(/** @lends instance.web.search.DateField# */{
    value_from: function (facetValue) {
        return time_utils.date_to_str(facetValue.get('value'));
    },
    complete: function (needle) {
        var m = moment(needle);
...
var DateTimeField = DateField.extend(/** @lends instance.web.search.DateTimeField# */{
    value_from: function (facetValue) {
        return time_utils.datetime_to_str(facetValue.get('value'));
    }
});
