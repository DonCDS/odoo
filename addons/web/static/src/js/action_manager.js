odoo.define('web.ActionManager', ['web.core', 'web.ViewManager', 'web.Widget', 'web.Dialog', 'web.data', 'web.session', 'web.pyeval', 'web.crash_manager', 'web.framework'], function (require) {
"use strict";
