odoo.define('web.ajax', ['web.time_utils'], function (require) {
"use strict";

var time_utils = require('web.time_utils');
...
var jsonRpc = function(url, fct_name, params, settings) {
    return genericJsonRpc(fct_name, params, function(data) {
        return $.ajax(url, _.extend({}, settings, {
            ...
            dataType: 'json',
            type: 'POST',
            data: JSON.stringify(data, time_utils.date_to_utc),
            contentType: 'application/json'
        }));
    });
};

var jsonpRpc = function(url, fct_name, params, settings) {
    settings = settings || {};
    return genericJsonRpc(fct_name, params, function(data) {
        var payload_str = JSON.stringify(data, time_utils.date_to_utc);
