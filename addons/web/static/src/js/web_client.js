odoo.define('web.WebClient', ['web.Widget', 'web.core', 'web.ActionManager', 'web.Model', 'web.session', 'web.utils', 'web.Notification', 'web.Menu', 'web.UserMenu', 'web.crash_manager', 'web.Loading', 'web.data', 'web.SystrayMenu'], function (require) {
"use strict";
...
var Widget = require('web.Widget'),
    ...
    Notification = require('web.Notification'),
    ...
    Loading = require('web.Loading');

var QWeb = core.qweb,
    _t = core._t;


var Client = Widget.extend({
...
return Client.extend({
    ...
    */
    ...
    update_logo: function() {
        ...
        var img = session.url('/web/binary/company_logo' + (company ? '?company=' + company : ''));
