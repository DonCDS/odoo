odoo.define('web.ViewManager', ['web.Model', 'web.Widget', 'web.session', 'web.SearchView', 'web.core', 'web.pyeval', 'web.data', 'web.Dialog', 'web.utils', 'web.formats', 'web.framework'], function (require) {
"use strict";
