openerp.mail = function (session) {
    ...
    mail.Mention = session.web.Widget.extend({
        ...
        keyup: function(e) {
            ...
            if(this.search_str) {
                this.timer = setTimeout(function() {
                    ...
                    new session.web.Model("res.partner").call("search_read", {
        ...
        render: function(res) {
            var $render = $(session.web.qweb.render('mail.mention', {'widget': _.extend(this, {"result": res})}));
    ...
    mail.ThreadComposeMessage = mail.MessageCommon.extend({
        ...
        start: function () {
            ...
            this.bind_events();
            // Store result of current user is from employee group ? (For mail.Mention)
            new session.web.Model('res.users').call('has_group', ['base.group_user']).done(function(is_employee) {
        ...
        */
        ...
        reinit: function() {
            ...
            if(this.is_employee && !this.is_log) {
                this.mail_mention = new mail.Mention(this);
        ...
        on_message_post: function (event) {
            ...
            this.html_body = mail.ChatterUtils.get_text2html(textarea.val());
