...
class test_mail(TestMail):
    ...
    def test_40_track_field(self):
        ...
        def _track_subtype(self, cr, uid, record, values, context=None):
            if 'public' in values and record.public == 'private':
                return 'mail.mt_private'
            elif 'name' in values and record.name == 'supername':
                return 'mail.mt_name_supername'
            elif 'group_public_id' in values and record.group_public_id:
                return 'mail.mt_group_public_set'
            elif 'group_public_id' in values and not record.group_public_id:
