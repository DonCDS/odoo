    ...
    openerp.website.if_dom_contains('.website_forum', function () {
        ...
        $('.link_url').on('change', function (ev) {
            ...
            $form.find(".title_loading").addClass('fa-spin fa-cog').removeClass('hidden fa-check fa-close');
            ...
            openerp.jsonRpc("/forum/get_url_title", 'call', {'url': url}).then(function (data) {
                if(data){
                    ...
                    $form.find(".title_loading").removeClass('fa-spin fa-cog').addClass('fa-check');
                }else{
                    ...
                    $form.find(".title_loading").removeClass('fa-spin fa-cog').addClass('fa-close');
                }
            });
        });
