odoo.define('web_kanban.common', ['web.core', 'web.data', 'web.form_common', 'web.formats', 'web.framework', 'web.pyeval', 'web.Registry', 'web.session', 'web.time_utils', 'web.utils', 'web.web_client', 'web.Widget'], function (require) {
    ...
    transform_record: function(record) {
        ...
        _.each(record, function(value, name) {
            ...
            if ((r.type === 'date' || r.type === 'datetime') && value) {
                r.raw_value = time_utils.auto_str_to_date(value);
            } else {
                r.raw_value = value;
            }
