...
class StreamListener(object):
    ...
    def on_connect(self):
        ...
        """
        _logger.info('StreamListener Connect to Twitter API')
        pass
    ...
    def on_error(self, status_code):
        ...
        raise Warning('StreamListener has error :%s.' % (status_code))
        return False
...
class Stream(object):
    ...
    def disconnect(self):
        if self.running is False:
            return
        self.listener.on_disconnect('StreamListener Disconnect to Twitter API')
        self.running = False
