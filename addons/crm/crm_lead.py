...
class crm_lead(format_address, osv.osv):
    ...
    _track = {
        'stage_id': {
            ...
            'crm.mt_lead_lost': lambda self, cr, uid, obj, ctx=None: obj.probability == 0 and obj.stage_id and obj.stage_id.on_change and obj.stage_id.sequence > 1,
        },
    }
    ...
    def merge_opportunity(self, cr, uid, ids, user_id=False, team_id=False, context=None):
        ...
        for opportunity in opportunities:
            sequence = -1
            if (opportunity.stage_id and (opportunity.stage_id.sequence <= 1) or (not opportunity.stage_id.on_change)) or (opportunity.probability not in [0, 100]):
