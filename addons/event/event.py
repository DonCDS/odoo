...
class event_registration(models.Model):
    ...
    def _prepare_attendee_values(self, registration):
        ...
        Kwargs can be used to update the method available parameter according to
        the specific flow that a module has to implement. """
        ...
        data.update({key: registration[key] for key in registration.keys() if key in self._all_columns})
        return data
