...
class purchase_order(osv.osv):
    ...
    def invoice_open(self, cr, uid, ids, context=None):
        ...
        action_id = mod_obj.xmlid_to_res_id(cr, uid, 'account.action_invoice_tree2') or False
        ...
        if len(inv_ids) > 1:
            ...
            res = mod_obj.xmlid_to_res_id(cr, uid, 'account.invoice_supplier_form') or False
