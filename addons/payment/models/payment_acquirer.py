...
class PaymentAcquirer(osv.Model):
    ...
    _columns = {
        ...
        'pending_msg': fields.html('Pending Message', help='Message displayed, if order is in pending state after having done the payment process.'),
        'done_msg': fields.html('Done Message', help='Message displayed, if order is done successfully after having done the payment process.'),
        'cancel_msg': fields.html('Cancel Message', help='Message displayed, if order is cancel during the payment process.'),
        'error_msg': fields.html('Error Message', help='Message displayed, if error is occur during the payment process.'),
        # Fees
    ...
    _defaults = {
        ...
        'pending_msg': '<i>Pending,</i> Your payment has been made but is pending, it will be processed within a short time.',
        'done_msg': '<i>Done,</i> Your online payment has been successfully processed. Thank you for your order.',
        'cancel_msg': '<i>Cancel,</i> Your payment has been canceled.',
        'error_msg': '<i>Error,</i> An error occurred. We cannot process your payment right now, please try again later.'
    }
