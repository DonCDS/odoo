...
class QWeb(orm.AbstractModel):
    ...
    * alternatively, override :meth:`~.get_converter_for` and return an
    ...
    def render_tag_call(self, element, template_attributes, generated_attributes, qwebcontext):
        ...
        # we need 1/ a valid context 2/ a t-lang tag with the t-call
        translation_poss = d.context and 'lang' in d.context and 'lang' in template_attributes
        ...
        if translation_poss and 'init_lang' in d.context:
